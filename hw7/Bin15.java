...
public class Bin15 {
    ...
    public Bin15(String input) {
        ...
        for (int count = 0; count < 15; count++) {
            ...
            if (c != '0' && c != '1') {
                String msg = "Your binary string contains non-binary characters";
                throw new IllegalArgumentException(msg);
            }
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof Bin15) {
        	Bin15 otherBin = (Bin15) o;
			//run through the string
			for (int count = 0; count < 15; count = count + 1) {
				if (myBinStr.charAt(count) != otherBin.myBinStr.charAt(count)) {
					return false;
				} 
			}
			return true;
    ...
    @Override
    public int hashCode() {
		int returnInt = Integer.parseInt(myBinStr, 2);
		return returnInt;	
    }
    ...
    */
    ...
    public static void main(String[] args) {
		...
		Bin15 one = new Bin15("000000000000000");
		System.out.println(one.hashCode());
		Bin15 two = new Bin15("011110001010101");
		System.out.println(two.hashCode());
		Bin15 three = new Bin15("111100000001111");
		System.out.println(three.hashCode());
		Bin15 four = new Bin15("111100000001111");
		Bin15 five = new Bin15("111100000001110");
